...
Source Server         : 192.168.204.26
Source Server Version : 50621
Source Host           : 40.125.162.231:3306
...
) ENGINE=InnoDB AUTO_INCREMENT=52776 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10203 DEFAULT CHARSET=utf8 COMMENT='删除ceph文件表';
...
CREATE TABLE `document_permission` (
  ...
  `permission` char(2) NOT NULL COMMENT '权限：-1关联只读、0只读、1读写、2管理、3创建者、99超级管理',
  `share_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_document_id` (`document_id`,`inc_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=48682 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=5768 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=26278 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='企业配置信息';
...
CREATE TABLE `log_document_rel` (
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=124288 DEFAULT CHARSET=utf8;
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10312 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10108 DEFAULT CHARSET=utf8 COMMENT='回收站';
...
CREATE TABLE `sys_dict` (
  ...
  `is_delete` char(1) NOT NULL COMMENT '是否删除：0否、1是',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典表';
